...
\thesistitle{Title of Your Thesis: Can Be\\Broken Across Lines}

\thesisauthor{Your Name} \thesisadvisor{Dr. Your Firstreader}

\thesisnumber{CS??-??} % SEE PAULINE LANZINE TO GET YOUR REPORT NUMBER!

\thesisreadera{Dr. Your Secondreader}
...
% ch:intro
\include{ch01_overview} % Introduction -- of course, you can name it anything!

% ch:relatedwork
\include{ch02_relatedwork} % Background, literature survey, ...
